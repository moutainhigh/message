...
public class TlsSigaturer {
    ...
    public static GenTLSSignatureResult GenTLSSignature(long expire,
        ...
        try {
            ...
            String userSig = new String(Base64UrlEncoder.base64EncodeUrl(Arrays.copyOfRange(compressBytes, 0, compressBytesLength)));
    ...
    public static CheckTLSSignatureResult CheckTLSSignature(String urlSig,
        ...
        byte[] compressBytes = Base64UrlEncoder.base64DecodeUrl(urlSig.getBytes(Charset.forName("UTF-8")));
