...
public class ImAccountServiceImpl implements ImAccountService {
    ...
    public ImAccount addImAccount(ImAccount imAccount) {
        ...
        if (!imAccount.isIdEncrypted()) {
            imAccount.setId(this.encryptAccountId(id));
        }
    ...
    @Override
    public String encryptAccountId(String id) {
        return symmetricCipher.encrypt(id);
    }

    @Override
    public String decryptAccountId(String id) {
        return symmetricCipher.decrypt(id);
    }
